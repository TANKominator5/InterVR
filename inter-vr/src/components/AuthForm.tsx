        ...
        <div className="w-full max-w-md bg-card border border-border rounded-3xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white text-black font-semibold rounded-xl hover:bg-foreground/90 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-white mb-6"
                >
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-sm font-medium text-foreground0 uppercase">Or</span>
                    <div className="h-px bg-muted flex-1" />
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        ...
                        <input
                            {...register("email")}
                            className={`w-full bg-background border ${errors.email ? 'border-red-500' : 'border-border'} rounded-xl px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-brand-purple transition-all`}
                    ...
                    <div>
                        ...
                        <input
                            type="password"
                            {...register("password")}
                            className={`w-full bg-background border ${errors.password ? 'border-red-500' : 'border-border'} rounded-xl px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-brand-purple transition-all`}
                            placeholder="••••••••"
                        />
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full flex items-center justify-center py-3 px-4 bg-brand-purple hover:bg-brand-purple-dark text-white font-semibold rounded-xl transition-all focus:outline-none focus:ring-2 focus:ring-brand-purple focus:ring-offset-2 focus:ring-offset-background disabled:opacity-70 disabled:cursor-not-allowed mt-2"
                    >
